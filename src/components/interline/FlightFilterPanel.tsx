...
const FlightFilterPanel: React.FC<FlightFilterPanelProps> = ({
  showFilters,
  priceRange,
  setPriceRange,
  resetFilters
  ...
  return (
    <CollapsibleContent className="px-6 py-4 grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 border-b">
      <div>
