      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <CitySelector
            ...
            error={formik.touched.fromCity && formik.errors.fromCity ? formik.errors.fromCity : undefined}
            cities={allCities}
          />
          ...
          <CitySelector
            ...
            error={formik.touched.toCity && formik.errors.toCity ? formik.errors.toCity : undefined}
            cities={allCities}
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <DatePicker
            ...
            error={formik.touched.departureDate && formik.errors.departureDate ? formik.errors.departureDate : undefined}
          />
          ...
          {formik.values.tripType === 'round-trip' && (
            <DatePicker
              ...
              error={formik.touched.returnDate && formik.errors.returnDate ? formik.errors.returnDate : undefined}
            />
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <CabinClassSelector 
            ...
            error={formik.touched.cabinClass && formik.errors.cabinClass ? formik.errors.cabinClass : undefined}
          />
