...
const InterlineHeader = () => {
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-950 via-violet-900 to-purple-950 overflow-hidden">
        {/* Decorative Pattern */}
          ...
          <div className="text-white space-y-6">
            ...
            >
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                ...
                <span className="text-sm font-medium text-white">Find best routes</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                <Map className="h-4 w-4 text-amber-300" />
                <span className="text-sm font-medium text-white">Global destinations</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                <Calendar className="h-4 w-4 text-amber-300" />
                <span className="text-sm font-medium text-white">Flexible dates</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                <Clock className="h-4 w-4 text-amber-300" />
                <span className="text-sm font-medium text-white">Real-time availability</span>
              </div>
            </motion.div>
          </div>
