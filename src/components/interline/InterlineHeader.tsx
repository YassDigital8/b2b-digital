    ...
    <div className="h-48 bg-gradient-to-r from-chamDarkBlue via-blue-600 to-blue-500 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 h-full flex items-center">
        <div className="text-white">
          <div className="flex items-center gap-2 mb-2 backdrop-blur-sm bg-white/5 py-1.5 px-3 rounded-full inline-block">
            <Plane className="h-5 w-5 text-chamGold" />
            <h1 className="text-2xl font-semibold font-display">Interline Booking</h1>
          </div>
          <p className="text-white/90 text-sm max-w-xl ml-1 font-light">
