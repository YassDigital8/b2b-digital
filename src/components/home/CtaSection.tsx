  ...
  return (
    <section className="py-16 bg-gradient-to-r from-chamDarkBlue to-chamBlue text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-lg">
          <motion.div 
          ...
          >
            <Link to="/signup" className="w-full">
              <Button size="lg" className="w-full bg-chamGold hover:bg-chamGold/90 text-white">
                Get Started
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link to="/contact" className="w-full">
              <Button size="lg" variant="outline" className="w-full border-white hover:bg-white/10 text-white">
                Contact Sales
              </Button>
            </Link>
          </motion.div>
